...
- Use Chrome browser (via claude-in-chrome MCP tools) to check and validate model information
...
- Before changing prices, read [the pricing contract](schemas/pricing.md). Use declared fields and run its validation checks.
